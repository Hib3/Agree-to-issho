  ...
  return (
    <main className="feature-screen manual-screen">
      ...
      <section className="paper-panel">
        ...
        <h2>ニュース</h2>
        <p>設定でニュース機能を有効にし、RSSのURLを登録します。見出しと短い説明をもとにアグリちゃんが話しますが、詳しい背景や真偽は元の記事で確認してください。</p>
        <h2>音</h2>
        <p>会話開始、ページ送り、決定時に短い効果音が鳴ります。設定で音量とミュートを変更できます。声の読み上げではありません。</p>
        <h2>オフライン</h2>
        <p>一度読み込んだ後は、ネットがなくても会話、学習、日記、保存を利用できます。ニュースの更新には通信が必要ですが、保存済みの見出しはオフラインでも読めます。</p>
